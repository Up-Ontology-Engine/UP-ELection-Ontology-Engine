...
def pydantic_to_ts(model) -> str:
    ...
    for field_name, field in model.model_fields.items():
        ...
        if (
            ...
            and annotation.__origin__ is UnionType
            or str(annotation).startswith("typing.Union")
        ...
        if annotation is str:
            ...
            str(annotation).startswith("typing.List")
            ...
            str(annotation).startswith("typing.Dict")
            or hasattr(annotation, "__origin__")
            and annotation.__origin__ is dict
        ):
            ts_type = "Record<string, any>"
...
def main():
    ...
    output_path = (
        Path(__file__).resolve().parent.parent / "frontend" / "nextjs" / "lib" / "api-types.ts"
    )
