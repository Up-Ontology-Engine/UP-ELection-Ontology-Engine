...
NODE_SIZES = {
    "Booth": 22, "AssemblyConstituency": 28, "AC": 28,
    "Issue": 20, "Party": 24, "Candidate": 22,
    "PulseEvent": 12, "Narrative": 18, "Scheme": 18,
    "YouTubeVideo": 14, "Channel": 20, "default": 14,
}
...
def _spring_layout(node_ids: list[str], edges: list[tuple[str, str]], iterations: int = 60) -> dict[str, tuple[float, float]]:
...
def _render_graph(nodes: list[dict], edges: list[dict]) -> None:
    ...
    edge_list = [(e.get("from", e.get("source", "")),
...
def _render_demo_graph(ac_id: str) -> None:
    ...
    demo_nodes = [
        {"id": ac_id,         "label": "AssemblyConstituency", "display_name": "GKP Urban",    "tooltip": "Gorakhpur Urban AC"},
        ...
        {"id": "roads",        "label": "Issue",                "display_name": "Roads",         "tooltip": "Roads & connectivity"},
        {"id": "YOGI_2022",    "label": "Candidate",            "display_name": "Yogi (BJP)",    "tooltip": "Yogi Adityanath"},
        {"id": "b_223",        "label": "Booth",                "display_name": "Booth 223",     "tooltip": "Rustampur area"},
        {"id": "b_185",        "label": "Booth",                "display_name": "Booth 185",     "tooltip": "Civil Lines area"},
        {"id": "jjm",          "label": "Scheme",               "display_name": "JJM",           "tooltip": "Jal Jeevan Mission"},
        {"id": "abpganga",     "label": "Channel",              "display_name": "ABP Ganga",     "tooltip": "ABP Ganga YouTube channel"},
        {"id": "yt_gkp1",      "label": "YouTubeVideo",         "display_name": "GKP Election",  "tooltip": "Gorakhpur chunav coverage"},
        {"id": "yt_gkp2",      "label": "YouTubeVideo",         "display_name": "Yogi Rally",    "tooltip": "Yogi Adityanath rally coverage"},
    ]
    demo_edges = [
