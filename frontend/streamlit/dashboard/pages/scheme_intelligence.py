...
def render(ac_id: str, ac_name: str, api_url: str) -> None:
    ...
    st.markdown("## 🏛️ Scheme Intelligence")
    info_bar(
        f"AC: {ac_name} ({ac_id})  |  Scheme coverage + execution gap analysis across all booths"
    )
...
def _render_gap_donut(schemes: list[dict]) -> None:
    ...
    fig.update_layout(
        **{**PLOTLY_LAYOUT, "height": 280, "showlegend": False, "margin": dict(l=0, r=0, t=10, b=0)}
    )
...
def _render_demo(_ac_name: str) -> None:
    ...
    demo = [
        ...
        {
            "scheme_name": "MGNREGA",
            "gap_type": "awareness_gap",
            "priority": "MEDIUM",
            "beneficiary_count": 3100,
            "issue_tag": "jobs",
        },
        {
            "scheme_name": "PM-Kisan",
            "gap_type": "performing_well",
            "priority": "LOW",
            "beneficiary_count": 5600,
            "issue_tag": "farmer",
        },
        {
            "scheme_name": "Ayushman Bharat",
            "gap_type": "in_progress",
            "priority": "MEDIUM",
            "beneficiary_count": 2200,
            "issue_tag": "health",
        },
        {
            "scheme_name": "Ujjwala 2.0",
            "gap_type": "performing_well",
            "priority": "LOW",
            "beneficiary_count": 4100,
            "issue_tag": "other",
        },
    ]
