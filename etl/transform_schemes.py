...
Sources:
  data/data/BlockWiseSummaryReport_2022-2023.xls  → block-wise panchayat financial summary
  data/data/BlockWiseSummaryReport_2024-2025.xls  → same, FY 2024-25
  data/data/DistrictWiseExpenditureReport.xls     → district-level receipts/payments
