...
def ingest():
    ...
    with engine.connect() as conn:
        ...
        excel_files = [
            ('data/data/Convert to xcel sheet/electoral_roll (1).xlsx', 'GKP_64', 1),
            ('data/data/Convert to xcel sheet/electoral_roll.xlsx', 'GKP_322', 2) # Based on metadata showing 322
        ]
        ...
        output_dir = 'data/data/Outputs of pipline/eroll_322_part2'
