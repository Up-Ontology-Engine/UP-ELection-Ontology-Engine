...
ELECTION_TOPICS = {
    ...
    "Unemployment": {
        "en": ["unemployment", "jobs", "youth", "employment", "rozgar", "berozgari", "job crisis"],
    ...
    "Education": {
        "en": ["school", "college", "university", "ddu", "education", "student", "teacher", "exam"],
        "hi": ["स्कूल", "कॉलेज", "शिक्षा", "छात्र", "विश्वविद्यालय"],
    },
    "Corruption": {
        "en": ["corruption", "scam", "bribe", "scandal", "fraud", "misappropriation"],
        "hi": ["भ्रष्टाचार", "घोटाला", "रिश्वत", "घपला", "धोखाधड़ी"],
    },
    "Communal": {
        "en": ["communal", "hindu", "muslim", "riot", "religion", "temple", "mosque", "minority"],
    ...
    "Local Leaders": {
        "en": ["ravi kishan", "gorakhpur mp", "gorakhpur mla", "akhilesh yadav", "mayawati"],
...
RSS_SOURCES = [
    ...
    },
    {
        ...
        "url": "https://feeds.feedburner.com/ndtvnews-uttar-pradesh",
        "lang": "en",
    },
    {
    ...
    {"name": "News18 – Politics", "url": "https://www.news18.com/rss/politics.xml", "lang": "en"},
    {
        ...
        "url": "https://www.firstpost.com/rss/politics.xml",
        "lang": "en",
    },
    {
    ...
    {"name": "Scroll – India", "url": "https://scroll.in/feed", "lang": "en"},
    # Hindi
    {
        "name": "Jagran – UP",
    ...
    {"name": "Patrika – UP", "url": "https://api.patrika.com/rss/uttar-pradesh", "lang": "hi"},
]
...
class GorakhpurElectionScraper:
    ...
    def _scrape_rss(self, src: dict) -> list:
        ...
        try:
            ...
            for entry in feed.entries[:30]:
                ...
                pub = getattr(entry, "published", getattr(entry, "updated", None))
    ...
    def run(self) -> list:
        ...
        for src in RSS_SOURCES:
            ...
            status = (
                f"{Fore.GREEN}+{len(arts)}{Style.RESET_ALL}"
                if arts
                else f"{Fore.RED}0{Style.RESET_ALL}"
            )
