"""Compatibility shim: moved into analytics.enrichment.myneta_complete_enrichment."""

from __future__ import annotations

from analytics.enrichment.myneta_complete_enrichment import *  # noqa: F401,F403
