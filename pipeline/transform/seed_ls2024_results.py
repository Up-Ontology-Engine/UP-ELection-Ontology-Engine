...
RESULTS: list[dict] = [
    ...
    {"candidate_id": "JAVED_ASHRAF_ALIAS_JAVED_SIMNANI_2024", "candidate_name": "JAVED ASHRAF ALIAS JAVED SIMNANI", "party_id": "SP",                     "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "AMITA_BHARATI_2024",                     "candidate_name": "AMITA BHARATI",                     "party_id": "IND",                    "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "SUDHANSHU_2024",                         "candidate_name": "Sudhanshu",                         "party_id": "IND",                    "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "ANAND_KUMAR_YADAV_ALIAS_ANAND_KUMAR_FAUJI_2024", "candidate_name": "Anand Kumar Yadav Alias Anand Kumar Fauji", "party_id": "BHARATHEEYA JAWAN KI", "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "SONU_RAI_2024",                          "candidate_name": "Sonu Rai",                          "party_id": "MERA ADHIKAAR RASHTR",   "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "SHIVSHANKAR_PRAJAPATI_2024",             "candidate_name": "SHIVSHANKAR PRAJAPATI",             "party_id": "BHAGIDARI PARTY(P)",     "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "PINTU_SAHANI_2024",                      "candidate_name": "Pintu Sahani",                      "party_id": "IND",                    "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "NAFEES_AKHTAR_2024",                     "candidate_name": "Nafees Akhtar",                     "party_id": "IND",                    "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "ANKIT_SHAH_2024",                        "candidate_name": "Ankit Shah",                        "party_id": "BHARATIYA YUVA JAN E",   "votes": None, "rank": None, "result": "lost", "is_winner": False},
    {"candidate_id": "SHRIRAM_PRASAD_2024",                    "candidate_name": "Shriram Prasad",                    "party_id": "AL-HIND PARTY",          "votes": None, "rank": None, "result": "lost", "is_winner": False},
]
...
def seed(engine: sa.Engine) -> int:
    ...
    with engine.connect() as conn:
        ...
        """), {"yr": ELECTION_YEAR, "con": CONSTITUENCY, "ac": "GKP_LS64"}).rowcount
        conn.commit()
    if deleted:
