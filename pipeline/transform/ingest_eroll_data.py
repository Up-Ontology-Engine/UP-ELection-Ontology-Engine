...
def ingest():
    ...
    with engine.connect() as conn:
        ...
        excel_files = [
            ...
            (
                "data/processed/Convert to xcel sheet/electoral_roll.xlsx",
                "GKP_322",
                2,
            ),  # Based on metadata showing 322
        ]
            ...
            """),
                {
                    ...
                    "ps_name": f"Part {part_no} (Extracted)",
                },
            )
        ...
        if os.path.exists(records_path):
            ...
            if records:
                ...
                logger.info(
                    f"  Updated {booth_id} from pipeline: Total={total}, M={male}, F={female}"
                )
