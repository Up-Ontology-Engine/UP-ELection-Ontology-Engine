...
Sources:
  data/processed/text/affidavit_gorakhpur_all_candidates.json  → candidate_master
  data/processed/text/neva_gorakhpur_mla_data.json             → enriches designation field
  data/processed/text/affidavit_gorakhpur_urban_2022_*.txt → criminal_cases + assets via regex
