...
HINGLISH_EXCLUSIVE = {
    "ne", "ki", "ka", "ke", "se", "bhi", "par", "aur", "ya", "toh",
    "kya", "kyu", "kyon", "kab", "kahan", "kaise", "nahi", "nhi", "na",
    "mat", "log", "logo", "sarkar", "bhai", "yaar", "paisa", "paise",
    "chahiye", "samasya", "pani", "paani", "bijli", "neta", "mantri",
    "chunav", "pratyashi", "jeete", "hare", "rasta", "sadak", "kaam",
    "vikas", "gunda", "gundagardi", "bhajpa", "sapai", "bahujan",
    "kamal", "hathi", "cycle", "hai", "hain", "ho", "kar", "raha",
    "re", "ko", "ye", "wo", "yogi", "modi", "akhilesh", "sarkar",
    "bura", "bhaiya", "badiya", "shukriya", "achha", "accha", "bilkul"
}
...
ENGLISH_STOPWORDS = {
    ...
    "were", "we", "when", "your", "can", "there", "use", "an", "each", "which",
...
HINGLISH_TRIGRAMS = {
    "hai", "nhi", "nah", "ahi", "kar", "rah", "aha", "log", "ogo", "aur", "bhi", 
    "par", "kab", "kya", "kyu", "kyo", "yon", "kis", "jis", "uss", "iss", "neh", 
    "nee", "sam", "ama", "mas", "asy", "sya", "pan", "ani", "aan", "bij", "ijl", 
    "jli", "net", "eta", "man", "ant", "ntr", "tri", "chu", "hun", "una", "nav", 
    "pra", "rat", "tya", "yas", "ash", "shi", "jee", "eet", "ete", "har", "are", 
    "ras", "ast", "sta", "sad", "ada", "dak", "kaa", "aam", "vik", "ika", "kas", 
    "gun", "und", "nda", "bha", "haj", "ajp", "jpa", "sap", "apa", "pai", "bah", 
    "ahu", "huj", "uja", "jan", "kam", "ama", "mal", "hat", "ath", "thi", "cyc", 
    "ycl", "cle", "yog", "ogi", "mod", "odi", "akh", "khi", "hil", "ile", "les", 
    "esh", "sar", "ark", "rka", "aar", "bur", "ura", "bha", "hai", "iyb", "iya", 
    "bad", "adi", "diy", "iya", "shu", "huk", "ukr", "kri", "riy", "iya", "ach", 
    "chh", "hha", "acc", "cca", "cha", "bil", "ilk", "lku", "kul", "tha", "tho", 
    "mer", "era", "ter", "era", "hum", "amn", "mni", "tum", "toh", "gup", "upt"
}

ENGLISH_TRIGRAMS = {
    "the", "and", "ing", "ent", "ion", "tio", "tha", "her", "ate", "for", "thi", 
    "tis", "oth", "wit", "ith", "ver", "all", "uld", "est", "con", "res", "ter", 
    "pre", "ave", "ere", "not", "but", "his", "the", "are", "our", "you", "out", 
    "tiv", "ive", "nce", "nce", "sho", "hou", "und", "thi", "tin", "ati", "tio"
}
