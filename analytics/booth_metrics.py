"""
Compute booth_metrics from pulse_events.
Also calculates issue momentum (% change vs previous window) and scheme gaps.
Run: python -m analytics.booth_metrics
"""
...
def compute_booth_metrics(engine: sa.Engine, window_days: int = 7):
    ...
    with engine.connect() as conn:
        # ── fetch pulse events for current window ─────────────────────────────
        ...
        # ── fetch prev window for momentum ───────────────────────────────────
