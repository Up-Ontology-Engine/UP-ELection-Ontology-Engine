...
from dashboard.components.war_room import inject_css, section, info_bar, risk_row, PLOTLY_LAYOUT
...
def render(ac_id: str, ac_name: str, booths: list[dict], api_url: str) -> None:
    ...
    info_bar(f"AC: {ac_name}  |  AI-synthesised strategic risks, opportunities, and action priorities")
    ...
    if not recs:
        st.info("Not enough data for recommendations yet. Run the full ETL + analytics pipeline first.")
...
def _render_action_plan(actions: list[dict]) -> None:
    ...
    for i, a in enumerate(actions, 1):
        ...
        pri_color = {"high": "#e74c3c", "medium": "#f39c12", "low": "#2ecc71"}.get(priority, "#8b949e")
    ...
    for t, col in [("Risk", "#e74c3c"), ("Opportunity", "#2ecc71")]:
        ...
        if subset:
            fig.add_trace(go.Scatter(
                ...
                marker=dict(size=18, color=col, opacity=0.85,
...
def _synthesise_from_booths(booths: list[dict]) -> dict:
    ...
    lean = "Lean BJP" if bjp_avg > opp_avg + 0.1 else "Lean Opposition" if opp_avg > bjp_avg + 0.1 else "Contested"
    ...
    return {
        ...
        "actions": [
            ...
            {"title": "Deploy field surveyors to data-sparse booths",
             ...
             "priority": "medium", "target_segment": "Survey team", "deadline": "2 weeks"},
        ],
    }
    ...
    demo = {
        ...
        "actions": [
            {"title": "Water-focused campaign in 23 high-dissatisfaction booths",
             ...
             "priority": "high", "target_segment": "Women + elderly", "deadline": "2 weeks"},
            ...
            {"title": "Expand data collection to 50+ data-sparse booths",
             ...
             "priority": "medium", "target_segment": "Survey team", "deadline": "3 weeks"},
        ],
    }
