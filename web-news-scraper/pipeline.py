...
GORAKHPUR_ANCHORS = [
    "gorakhpur", "gorakhnath", "brd medical", "ddu gorakhpur",
    "gida gorakhpur", "rapti gorakhpur", "गोरखपुर", "गोरखनाथ",
]

ELECTION_TOPICS = {
    "Yogi Adityanath":      {"kw": ["yogi adityanath","yogi","cm yogi","mahant yogi","योगी आदित्यनाथ","योगी"]},
    "Development":          {"kw": ["development","vikas","highway","airport","smart city","inaugurat","विकास","सड़क","बिजली"]},
    "Unemployment":         {"kw": ["unemployment","berozgari","jobs","rozgar","youth employment","बेरोजगारी","रोजगार","नौकरी"]},
    "Law and Order":        {"kw": ["crime","police","gangster","mafia","murder","robbery","encounter","अपराध","पुलिस","माफिया","हत्या"]},
    "Farmers":              {"kw": ["farmer","kisan","sugarcane","crop","msp","irrigation","fertilizer","किसान","गन्ना","फसल","सिंचाई"]},
    "Healthcare":           {"kw": ["hospital","health","brd medical","doctor","medicine","encephalitis","अस्पताल","स्वास्थ्य","डॉक्टर"]},
    "Education":            {"kw": ["school","college","university","ddu","student","teacher","स्कूल","शिक्षा","छात्र"]},
    "Corruption":           {"kw": ["corruption","scam","bribe","fraud","scandal","भ्रष्टाचार","घोटाला","रिश्वत"]},
    "Communal":             {"kw": ["communal","riot","hindu","muslim","temple","mosque","दंगा","सांप्रदायिक"]},
    "Flood":                {"kw": ["flood","rapti","rohini","inundation","बाढ़","राप्ती"]},
    "Party Politics":       {"kw": ["bjp","samajwadi","bsp","congress","nda","election","vote","rally","भाजपा","सपा","चुनाव","वोट"]},
    "Local Leaders":        {"kw": ["ravi kishan","gorakhpur mp","gorakhpur mla","akhilesh","mayawati","रवि किशन","अखिलेश"]},
}

RSS_SOURCES = [
    {"name": "TOI UP",             "url": "https://timesofindia.indiatimes.com/rssfeeds/-2128936835.cms",         "lang": "en"},
    ...
    {"name": "Jagran UP",          "url": "https://www.jagran.com/rss/news-national-uttar-pradesh.xml",           "lang": "hi"},
    {"name": "Amar Ujala UP",      "url": "https://www.amarujala.com/rss/uttar-pradesh.xml",                     "lang": "hi"},
    {"name": "Navbharat Times",    "url": "https://navbharattimes.indiatimes.com/rssfeedsdefault.cms",            "lang": "hi"},
    {"name": "Live Hindustan UP",  "url": "https://www.livehindustan.com/rss/up-uttarakhand.xml",                "lang": "hi"},
...
PRO_SIGNALS = [
    ...
    "inaugurates","inaugurated","launches","launched","dedicate","dedicates",
    "foundation stone","lays foundation","development project","infrastructure project",
    "smart city","metro gorakhpur","gorakhpur airport","gorakhpur link expressway",
    "fertilizer plant","double engine","double-engine government","sabka saath",
    "amrit kaal","viksit bharat","new project","sets up",
    # Law & order wins
    "encounter","mafia eliminated","gangster arrested","crime down","crime reduced",
    "law and order improved","safe uttar pradesh","bulldozer action","anti-mafia",
    "goonda raj ended","crime control",
    # Welfare credited to BJP
    "free ration","pm awas","ujjwala","ayushman","jan dhan","bijli","swachh bharat",
    "toilet","house built","scheme beneficiary","pm kisan","kisan samman",
    # Positive words about BJP/Yogi
    "yogi praised","modi praised","bjp achievement","bjp government delivers",
    "cm yogi inaugurates","cm yogi launches","pm modi inaugurates",
    "bjp wins","bjp victory","saffron wave","bjp leads",
    # Hindi pro signals
    "विकास कार्य","उद्घाटन","शिलान्यास","लोकार्पण","नई परियोजना",
    "मुफ्त राशन","आयुष्मान","उपलब्धि","सफलता","विकसित",
    "कानून व्यवस्था","माफिया मुक्त","अपराध मुक्त","डबल इंजन",
    "योगी की सराहना","भाजपा की जीत","भाजपा सरकार का विकास",
]

ANTI_SIGNALS = [
    # Corruption / scandal
    "corruption","scam","bribe","fraud","misappropriation","embezzle",
    "scandal","land grab","illegal","irregularities","paper leak",
    "भ्रष्टाचार","घोटाला","रिश्वत","घपला","धोखाधड़ी",
    # Unemployment
    "unemployment","no jobs","job loss","youth unemployed","berozgari",
    "बेरोजगारी","नौकरी नहीं","रोजगार नहीं","पलायन","migration crisis",
    # Inflation / poverty
    "inflation","price rise","costly","petrol price hike","lpg costly",
    "महंगाई","मूल्य वृद्धि","महंगा","पेट्रोल","गैस महंगी",
    # Law & order failures
    "rape","murder","kidnapping","lynching","mob violence","communal riot",
    "criminals roam","goonda","extortion","drugs","organised crime",
    "बलात्कार","हत्या","अपहरण","दंगा","अपराधी","वसूली",
    # Farmer distress
    "farmer suicide","kisan aatmhatya","sugarcane dues unpaid","ganna bhugtan",
    "किसान आत्महत्या","गन्ना बकाया","किसान परेशान","कृषि संकट",
    # BRD / healthcare failures
    "brd deaths","oxygen deaths","encephalitis deaths","hospital neglect",
    "अस्पताल में मौत","ऑक्सीजन","इलाज न मिलना",
    # Flood / disaster mismanagement
    "flood victims ignored","flood relief delayed","flood mismanagement",
    "बाढ़ पीड़ित","राहत नहीं","बाढ़ में मौत",
    # Anti-BJP political signals
    "anti-incumbency","voters angry","public anger","bjp loses","bjp setback",
    "bjp defeat","opposition wins","bjp criticized","yogi criticized",
    "bjp fails","government failure","failed government",
    "akhilesh slams","sp attacks bjp","bsp slams yogi","congress slams",
    "protest against bjp","dharna against","demonstration against yogi",
    "जनता नाराज","सरकार विफल","योगी की आलोचना","भाजपा विरोध",
    "हार","भाजपा की हार","विरोध प्रदर्शन","सरकार पर निशाना",
]
...
def safe_date(raw):
    try: return dateparser.parse(str(raw), ignoretz=True).isoformat()
...
def detect_topics(text):
    t = text.lower()
    return [name for name, cfg in ELECTION_TOPICS.items()
    ...
    def _parse_feed(self, src):
        ...
        try:
            ...
            for e in feed.entries[:30]:
                ...
                if link in self.seen: continue
                text = f"{title} {clean_html(summary)}"
                if not is_gorakhpur(text): continue
                topics = detect_topics(text)
                if not topics: continue
                self.seen.add(link)
                out.append({
                    "title": title, "summary": clean_html(summary)[:500],
                    "url": link, "source": src["name"], "language": src["lang"],
                    "published": safe_date(pub), "topics": topics,
        ...
        try:
            ...
            for sel in ["article", ".article-body", "[itemprop='articleBody']", ".content-body"]:
                ...
                if node:
                    ...
                    if len(txt) > 150: return re.sub(r"\s+", " ", txt)[:3000]
            return re.sub(r"\s+", " ", " ".join(p.get_text() for p in soup.find_all("p") if len(p.get_text())>40))[:3000]
        except: return ""
...
COLORS = {"PRO-BJP": Fore.GREEN, "LEAN-PRO": Fore.LIGHTGREEN_EX,
          "NEUTRAL": Fore.YELLOW, "LEAN-ANTI": Fore.LIGHTRED_EX, "ANTI-BJP": Fore.RED}
...
def print_report(articles):
    ...
    for lbl in ["PRO-BJP", "ANTI-BJP"]:
        ...
        for a in grp[:6]:
            ...
            if s["pro_matched"]:  print(f"      {Fore.GREEN}+ {', '.join(s['pro_matched'][:3])}{Style.RESET_ALL}")
            if s["anti_matched"]: print(f"      {Fore.RED}- {', '.join(s['anti_matched'][:3])}{Style.RESET_ALL}")
    ...
    for topic in all_topics:
        p = sum(1 for a in articles if topic in a.get("topics",[]) and a["bjp_sentiment"]["label"] in ("PRO-BJP","LEAN-PRO"))
        n = sum(1 for a in articles if topic in a.get("topics",[]) and a["bjp_sentiment"]["label"] in ("ANTI-BJP","LEAN-ANTI"))
        u = sum(1 for a in articles if topic in a.get("topics",[]) and a["bjp_sentiment"]["label"] == "NEUTRAL")
        print(f"  {topic:<28} {Fore.GREEN}{p:>5}{Style.RESET_ALL} {Fore.RED}{n:>5}{Style.RESET_ALL} {Fore.YELLOW}{u:>8}{Style.RESET_ALL}")
...
def save_all(articles, groups):
    ...
    with open(master, "w", encoding="utf-8") as f:
        json.dump({"generated_at": datetime.now().isoformat(),
                   "total": len(articles), "articles": articles}, f,
    ...
    for lbl, arts in groups.items():
        ...
        with open(path, "w", encoding="utf-8") as f:
            json.dump({"label": lbl, "total": len(arts), "articles": arts},
